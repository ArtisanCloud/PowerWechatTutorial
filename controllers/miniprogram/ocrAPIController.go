...
func APIOCRBankCardByData(c *gin.Context) {
	...
	rs, err := services.AppMiniProgram.OCR.Bankcard("", &power.HashMap{
...
func APIOCRBusinessLicenseByURL(c *gin.Context) {
	...
	rs, err := services.AppMiniProgram.OCR.BusinessLicense(url, nil)
...
func APIOCRBusinessLicenseByData(c *gin.Context) {
	...
	mediaPath := "./resource/cloud.jpg"
	value, err := ioutil.ReadFile(mediaPath)
	rs, err := services.AppMiniProgram.OCR.BusinessLicense("", &power.HashMap{
		"name":  "cloud.jpg", // 请确保文件名有准确的文件类型
		"value": value,
	})
...
func APIOCRDriverLicenseByURL(c *gin.Context) {
	...
	rs, err := services.AppMiniProgram.OCR.DriverLicense(url, nil)
...
func APIOCRDriverLicenseByData(c *gin.Context) {
	...
	mediaPath := "./resource/cloud.jpg"
	value, err := ioutil.ReadFile(mediaPath)
	rs, err := services.AppMiniProgram.OCR.DriverLicense("", &power.HashMap{
		"name":  "cloud.jpg", // 请确保文件名有准确的文件类型
		"value": value,
	})
...
func APIOCRIDCardByURL(c *gin.Context) {
	...
	rs, err := services.AppMiniProgram.OCR.IDCard(url, nil)
...
func APIOCRIDCardByData(c *gin.Context) {
	...
	mediaPath := "./resource/cloud.jpg"
	value, err := ioutil.ReadFile(mediaPath)
	rs, err := services.AppMiniProgram.OCR.IDCard("", &power.HashMap{
		"name":  "cloud.jpg", // 请确保文件名有准确的文件类型
		"value": value,
	})
...
func APIOCRPrintedTextByURL(c *gin.Context) {
	...
	rs, err := services.AppMiniProgram.OCR.PrintedText(url, nil)
...
func APIOCRPrintedTextByData(c *gin.Context) {
	...
	mediaPath := "./resource/cloud.jpg"
	value, err := ioutil.ReadFile(mediaPath)
	rs, err := services.AppMiniProgram.OCR.PrintedText("", &power.HashMap{
		"name":  "cloud.jpg", // 请确保文件名有准确的文件类型
		"value": value,
	})
...
func APIOCRVehicleLicenseByURL(c *gin.Context) {
	...
	rs, err := services.AppMiniProgram.OCR.VehicleLicense("photo", url, nil)
...
func APIOCRVehicleLicenseByData(c *gin.Context) {
	...
	mediaPath := "./resource/cloud.jpg"
	value, err := ioutil.ReadFile(mediaPath)
	rs, err := services.AppMiniProgram.OCR.VehicleLicense("photo", "", &power.HashMap{
		"name":  "cloud.jpg", // 请确保文件名有准确的文件类型
		"value": value,
	})
