...
func main() {
	...
	{
		wecomRouter.POST("/message/send", wecom.SendTextMsg)
		wecomRouter.POST("/message/recall", wecom.RecallMsg)

		// 通讯录
		wecomRouter.GET("/department", wecom.DepartmentList)
		wecomRouter.POST("/department", wecom.DepartmentCreate)
		wecomRouter.PUT("/department", wecom.DepartmentUpdate)
		wecomRouter.DELETE("/department", wecom.DepartmentDelete)
		wecomRouter.GET("/department/users/simple", wecom.UserSimpleList)
		wecomRouter.GET("/department/users/detail", wecom.UserDetailList)
		wecomRouter.POST("/user", wecom.UserCreate)
		wecomRouter.GET("/user", wecom.UserGet)
		wecomRouter.PUT("/user", wecom.UserUpdate)
		wecomRouter.DELETE("/user", wecom.UserDelete)
		wecomRouter.DELETE("/user/batch", wecom.UserBatchDelete)
		wecomRouter.GET("/userIdToOpenId", wecom.UserIdToOpenId)
		wecomRouter.GET("/openIdToUserId", wecom.OpenIdToUserId)
		wecomRouter.GET("/auth/accept", wecom.AuthAccept)
		wecomRouter.GET("/invite/batch", wecom.BatchInvite)
		wecomRouter.GET("/invite/qrcode", wecom.GetJoinQrCode)
		wecomRouter.GET("/active/stat", wecom.GetActiveStat)
		wecomRouter.GET("/tag/user", wecom.TagUserGet)
		wecomRouter.PUT("/tag/user", wecom.TagUserAdd)
		wecomRouter.DELETE("/tag/user", wecom.TagUserDel)
		wecomRouter.GET("/tag", wecom.TagList)
		wecomRouter.POST("/tag", wecom.TagCreate)
		wecomRouter.PUT("/tag", wecom.TagUpdate)
		wecomRouter.DELETE("/tag", wecom.TagDelete)
